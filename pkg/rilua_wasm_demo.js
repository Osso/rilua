/* @ts-self-types="./rilua_wasm_demo.d.ts" */
 ...
 * @returns {string}
 */
export function eval_lua(code) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.eval_lua(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rilua_wasm_demo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
